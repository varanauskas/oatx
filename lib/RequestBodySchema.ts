...
import type { ComponentRef, ComponentTypes, ObjectWithContentSchema, PathTemplate, RequiredDoc, DocOperation, DocPath, DocPathMethod, DocPathTemplate } from "./common";
...
> = DocOperation<Doc, Path, Method>["requestBody"] extends ReferenceObject
    ...
    ? ComponentRef<Doc, "requestBodies", DocOperation<Doc, Path, Method>["requestBody"]>
    : never
